...
public class thisbody : MonoBehaviour
{
    ...
    public GameObject damagecube_1;
    public GameObject damagecube_2;
    public GameObject damagecube_3;
    public GameObject damagecube_4;
    ...
    void Update()
    {
        ...
        if (switch_error10.activeSelf && Input.GetKeyDown(KeyCode.Y))
        {
            ...
            HP.SetActive(true);
            damagecube_1.SetActive(true);
            damagecube_2.SetActive(true);
            damagecube_3.SetActive(true);
            damagecube_4.SetActive(true);
            monitor2_movie.SetActive(false);
     ...
     　　　　   {
      ...
      　　　　  }
       ...
       　　　　 if (switch_lesson1.activeSelf && Input.GetKeyDown(KeyCode.W))
        ...
        if (switch_body.activeSelf && switch_body3.activeSelf && Input.GetKeyDown(KeyCode.Space))
        {
            thisbody1.SetActive(true);
            thisbody2.SetActive(false);
            thisbody3.SetActive(false);
        ...
        if (switch_body.activeSelf && switch_body4.activeSelf && Input.GetKeyDown(KeyCode.Space))
        {
            thisbody1.SetActive(false);
            thisbody2.SetActive(false);
            thisbody3.SetActive(false);
            thisbody4.SetActive(true);
            enemy4.SetActive(false);
            thisbodysound.SetActive(true);
            enemys4.SetActive(true);
            //tyuunyuu.SetActive(true);
            //tyunyu_audio.SetActive(true);
    ...
    void title()
        ...
        void errorsound()
        {
            ...
            ketteiSE.SetActive(false);
            errorSE_lesson1.SetActive(false);
            errorSE_lesson2.SetActive(false);
            errorSE_lesson3.SetActive(false);
